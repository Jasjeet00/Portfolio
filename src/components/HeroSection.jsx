	...
	return (
		<div id="hero" className="flex items-center justify-center flex-col py-20">
			<div className="text-center">
				...
				I am a 4th year Computer Science major and a Business Administration minor student at Memorial University of Newfoundland and Labrador. I am a results driven person, with a strive to constantly improve and develop both personally and professionally.{' '}
				</p>
				<a
					href="#works"
